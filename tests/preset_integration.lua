...
equal(#settings.slots.slot_2, 2)
equal(settings.slots.slot_2[1].id, 1009)
equal(settings.slots.slot_2[2].id, 909)
equal(saves, 1)
assert(output[#output]:find('Preset 2 saved: Lion II, Mihli Aliapoh.', 1, true))
